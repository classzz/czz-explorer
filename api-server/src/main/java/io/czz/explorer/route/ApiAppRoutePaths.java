...
public interface ApiAppRoutePaths {
	...
	public static interface V1{
		...
		public static final String ACCOUNT_NODE_INFO_ = ACCOUNT+"/node/info";
		public static final String ACCOUNT_UTXOS = ACCOUNT+"/utxos";
		public static final String ACCOUNT_UTXOS_LIMIT = ACCOUNT+"/utxos/limit";
		public static final String ACCOUNT_TRANS_LIMIT = ACCOUNT+"/trans/limit";
		public static final String ACCOUNT_ERROR_UTXO = ACCOUNT+"/utxo/error";
		...
		public static final String BLOCK_LATEST_HEIGHT = BLOCK+"/latestHeight";
		public static final String BLOCK_LATEST_HEIGHT_M = BLOCK+"/latest/height";
		...
		public static final String BLOCK_SEARCH_DIFFICULTY = BLOCK+"/difficulty";
		public static final String BLOCK_ERROR_ = BLOCK+"/error";
		public static final String BLOCK_FIX = BLOCK+"/fix";
