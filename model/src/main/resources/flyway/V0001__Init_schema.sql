...
CREATE TABLE `account` (
  ...
  `total_input` decimal(32,8)  DEFAULT NULL,
  `total_output` decimal(32,8)  DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `block` (
  ...
  `transaction_fees` decimal(32,8)  NOT NULL DEFAULT '0',
  `output_total` decimal(32,8)  NOT NULL DEFAULT '0',
  ...
  `reward` decimal(32,8)  unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `transaction` (
  ...
  `fees` decimal(32,8)  unsigned DEFAULT NULL,
  `total_input` decimal(32,8)  unsigned DEFAULT NULL,
  `total_output` decimal(32,8)  unsigned DEFAULT NULL,
...
CREATE TABLE `transfer_in` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `amount` decimal(32,8)  unsigned NOT NULL default '0',
