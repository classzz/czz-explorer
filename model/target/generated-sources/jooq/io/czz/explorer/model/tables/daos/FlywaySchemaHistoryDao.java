...
public class FlywaySchemaHistoryDao extends DAOImpl<FlywaySchemaHistoryRecord, io.czz.explorer.model.tables.pojos.FlywaySchemaHistory, Integer> {

    /**
     * Create a new FlywaySchemaHistoryDao without any configuration
     */
    public FlywaySchemaHistoryDao() {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, io.czz.explorer.model.tables.pojos.FlywaySchemaHistory.class);
    }
    ...
    public FlywaySchemaHistoryDao(Configuration configuration) {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, io.czz.explorer.model.tables.pojos.FlywaySchemaHistory.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(io.czz.explorer.model.tables.pojos.FlywaySchemaHistory object) {
     ...
     */
    public List<io.czz.explorer.model.tables.pojos.FlywaySchemaHistory> fetchByInstalledRank(Integer... values) {
     ...
     */
    public io.czz.explorer.model.tables.pojos.FlywaySchemaHistory fetchOneByInstalledRank(Integer value) {
     ...
     */
    public List<io.czz.explorer.model.tables.pojos.FlywaySchemaHistory> fetchByVersion(String... values) {
     ...
     */
    public List<io.czz.explorer.model.tables.pojos.FlywaySchemaHistory> fetchByDescription(String... values) {
     ...
     */
    public List<io.czz.explorer.model.tables.pojos.FlywaySchemaHistory> fetchByType(String... values) {
     ...
     */
    public List<io.czz.explorer.model.tables.pojos.FlywaySchemaHistory> fetchByScript(String... values) {
     ...
     */
    public List<io.czz.explorer.model.tables.pojos.FlywaySchemaHistory> fetchByChecksum(Integer... values) {
     ...
     */
    public List<io.czz.explorer.model.tables.pojos.FlywaySchemaHistory> fetchByInstalledBy(String... values) {
     ...
     */
    public List<io.czz.explorer.model.tables.pojos.FlywaySchemaHistory> fetchByInstalledOn(Timestamp... values) {
     ...
     */
    public List<io.czz.explorer.model.tables.pojos.FlywaySchemaHistory> fetchByExecutionTime(Integer... values) {
     ...
     */
    public List<io.czz.explorer.model.tables.pojos.FlywaySchemaHistory> fetchBySuccess(Byte... values) {
