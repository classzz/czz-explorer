...
public class BlockRecord extends UpdatableRecordImpl<BlockRecord> implements Record22<ULong, Timestamp, ULong, String, String, String, String, String, Integer, Double, Double, Double, Double, Double, Long, Long, String, ULong, ULong, Integer, Double, Integer> {

    private static final long serialVersionUID = 669603331;
    ...
    /**
     * Setter for <code>czztmp.block.is_main</code>.
     */
    ...
    /**
     * Getter for <code>czztmp.block.is_main</code>.
     */
     ...
     */
    @Override
    public Row22<ULong, Timestamp, ULong, String, String, String, String, String, Integer, Double, Double, Double, Double, Double, Long, Long, String, ULong, ULong, Integer, Double, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row22<ULong, Timestamp, ULong, String, String, String, String, String, Integer, Double, Double, Double, Double, Double, Long, Long, String, ULong, ULong, Integer, Double, Integer> valuesRow() {
     ...
     */
    @Override
    public BlockRecord value22(Integer value) {
        setIsMain(value);
        return this;
    }
     ...
     */
    public BlockRecord(ULong id, Timestamp createdTime, ULong height, String hash, String prevBlockHash, String nextBlockHash, String merkleRoot, String minerAddress, Integer txCount, Double difficulty, Double sumDifficulty, Double hashRate, Double transactionFees, Double outputTotal, Long size, Long version, String versionHex, ULong nonce, ULong bits, Integer confirmations, Double reward, Integer isMain) {
        super(Block.BLOCK);
